    ...
    public partial class RandomMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Addesses", x => x.AddressID);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Addesses_AddressID",
                        column: x => x.AddressID,
                        principalTable: "Addesses",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BooksCategories", x => x.BookCategoriesID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Banneds", x => x.BannedID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collections_UserBooks_UserBookID",
                        column: x => x.UserBookID,
                        principalTable: "UserBooks",
                        principalColumn: "UserBookID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_UserBooks_UserBookID",
                        column: x => x.UserBookID,
                        principalTable: "UserBooks",
                        principalColumn: "UserBookID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exchanges_UserBooks_UserBookID",
                        column: x => x.UserBookID,
                        principalTable: "UserBooks",
                        principalColumn: "UserBookID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Likes_UserBooks_UserBookID",
                        column: x => x.UserBookID,
                        principalTable: "UserBooks",
                        principalColumn: "UserBookID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Collections_UserBookID",
                table: "Collections",
                column: "UserBookID");
